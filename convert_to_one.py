...
def convert_to_one():
    file_directory = 'C:/Users/Fabio Barros/Desktop/Qualificação/Novos Resultados - Sem Rydls/'
    ...
    for classifier in classifiers:
        results_folder = file_directory + classifier
        results_df = pd.DataFrame(columns=columns)
        final_file_name = results_directory + classifier + '.csv'
