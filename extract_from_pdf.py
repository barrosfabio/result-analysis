...
key_mapping = {'0':'Bacterial_Klebsiella','1':'Bacterial_Legionella','2':'Bacterial_Mycoplasma',
               '3':'Bacterial_Streptococcus','4':'Fungal_Pneumocystis','5':'Lipoid','6':'Normal','7':'Viral_COVID','8':'Viral_SARS'}
rf_directory = 'C:/Users/Fabio Barros/Desktop/Qualificação/Novos Resultados/'+ algorithm + '/'
result_dir = 'C:\\Users\\Fabio Barros\\Desktop\\Qualificação\\Novos Resultados\\per_class\\'+algorithm+'\\'
        ...
        for approach in resampling_approach:
            ...
            for resampling in resampling_algorithms:
                ...
                with pdfplumber.open(path) as pdf:
                    ...
                    cropped_page = first_page.crop((500, 212,(first_page.width-260), (first_page.height-460)),relative=False)
